...
public:
	...
	enum StationaryFieldObjectID
	{
        ...
        FO_PENALTY_CENTER_PROJECTED_YELLLOW = 23,
        FO_PENALTY_CENTER_PROJECTED_BLUE = 24,
        FO_BASELINE_CENTER_PROJECTED_YELLOW = 25,
        FO_BASELINE_CENTER_PROJECTED_BLUE = 26,

		//Penalty Spots
        FO_PENALTY_YELLOW = 27,
        FO_PENALTY_BLUE = 28,

        FO_CORNER_CENTRE_CIRCLE_INTERSECT_LEFT  = 29,
        FO_CORNER_CENTRE_CIRCLE_INTERSECT_RIGHT 	= 30,

        NUM_STAT_FIELD_OBJECTS = 31
	...
	double m_timestamp;
	Self self;
	std::vector<StationaryObject> stationaryFieldObjects;
	std::vector<MobileObject> mobileFieldObjects;
	std::vector<AmbiguousObject> ambiguousFieldObjects;
	FieldObjects();
