...
NUSensors::NUSensors(): m_initialised(false)
{
    ...
    init_imu_cov[IMUModel::kstates_gyro_offset_x][IMUModel::kstates_gyro_offset_x] = 25.0;
    init_imu_cov[IMUModel::kstates_gyro_offset_y][IMUModel::kstates_gyro_offset_y] = 25.0;
