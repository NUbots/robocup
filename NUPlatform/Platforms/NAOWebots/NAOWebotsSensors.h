...
private:
    ...
    // Sensors
    static std::vector<std::string> m_servo_names;                        //!< a std::vector of the names of each servo in the Webot NAO
    std::vector<webots::Servo*> m_servos;                           //!< a std::vector containing pointers to each of the servos in the Webot NAO.
    ...
    static std::vector<std::string> m_distance_names;                     //!< a std::vector of the names of each of the distance sensors in Webot NAO
    std::vector<webots::DistanceSensor*> m_distance_sensors;         //!< a std::vector containing pointers to each of the distance sensors in the Webot NAO
    static std::vector<std::string> m_foot_sole_names;                    //!< a std::vector of the names of each of the foot touch sensors in Webot NAO
    std::vector<webots::TouchSensor*> m_foot_sole_sensors;           //!< a std::vector of pointers to each of the foot force sensors in the Webot NAO
    static std::vector<std::string> m_foot_bumper_names;                  //!< a std::vector of the foot bumper names
    std::vector<webots::TouchSensor*> m_foot_bumper_sensors;         //!< a std::vector of pointers to buttons
