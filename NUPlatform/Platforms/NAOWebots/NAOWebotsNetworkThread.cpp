...
NAOWebotsNetworkThread::~NAOWebotsNetworkThread()
{
    delete m_game_packet;
}

void NAOWebotsNetworkThread::periodicFunction()
{
    // Do receiving
...
void NAOWebotsNetworkThread::convertToGamePacket(const RoboCupGameControlDataWebots* data)
{
