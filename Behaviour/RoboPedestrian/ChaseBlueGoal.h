...
{
public:
    ChaseBlueGoal(RoboPedestrianProvider* parent) : ChaseObject(parent, FieldObjects::FO_BLUE_RIGHT_GOALPOST, FieldObjects::FO_BLUE_GOALPOST_UNKNOWN), m_goal_reached_count(0) {};
