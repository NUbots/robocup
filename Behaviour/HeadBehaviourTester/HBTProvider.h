...
#ifndef HBTBEHAVIOUR_H
#define HBTBEHAVIOUR_H
...
class HBTProvider : public BehaviourFSMProvider
{
public:
    HBTProvider(Behaviour* manager, bool pauseable = false);
    ~HBTProvider();
protected:
