...
{
public:
    ChaseYellowGoal(WalkOptimisationProvider* parent) : ChaseObject(parent, FieldObjects::FO_YELLOW_LEFT_GOALPOST, FieldObjects::FO_YELLOW_GOALPOST_UNKNOWN), m_goal_reached_count(0) {};
    ...
    virtual BehaviourState* nextState()
    {
        ...
        {
            debug << "ChaseYellowGoal -> SearchYellowGoal. Goal lost." << endl;
        ...
        else if (m_target.measuredDistance() < 150)
        {
            ...
            {
                m_goal_reached_count = 0;
                debug << "ChaseYellowGoal -> SearchBlueGoal. Goal reached." << endl;
