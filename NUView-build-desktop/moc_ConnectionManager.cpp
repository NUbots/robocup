...
#include "../NUView/ConnectionManager/ConnectionManager.h"
...
static const char qt_meta_stringdata_ConnectionManager[] = {
    "ConnectionManager\0\0hosts\0"
    "newHosts(vector<NUHostInfo>)\0"
    "onListButton()\0onInputFinished()\0"
};

const QMetaObject ConnectionManager::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ConnectionManager,
...
int ConnectionManager::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: newHosts((*reinterpret_cast< vector<NUHostInfo>(*)>(_a[1]))); break;
        case 1: onListButton(); break;
        case 2: onInputFinished(); break;
        default: ;
        }
        _id -= 3;
    }
...
// SIGNAL 0
void ConnectionManager::newHosts(vector<NUHostInfo> _t1)
{
