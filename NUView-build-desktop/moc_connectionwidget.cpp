...
#include "../NUView/connectionwidget.h"
...
static const char qt_meta_stringdata_ConnectionWidget[] = {
    "ConnectionWidget\0\0datagram\0"
    "PacketReady(QByteArray*)\0connectToRobot()\0"
    "disconnectFromRobot()\0name\0"
    "updateRobotName(QString)\0"
    "readPendingDatagrams()\0"
};

const QMetaObject ConnectionWidget::staticMetaObject = {
    { &QDockWidget::staticMetaObject, qt_meta_stringdata_ConnectionWidget,
...
int ConnectionWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: disconnectFromRobot(); break;
        case 3: updateRobotName((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 4: readPendingDatagrams(); break;
        default: ;
        }
        _id -= 5;
    }
...
// SIGNAL 0
void ConnectionWidget::PacketReady(QByteArray * _t1)
{
