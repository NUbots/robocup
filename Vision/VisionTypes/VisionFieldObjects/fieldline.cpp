...
std::ostream& operator<< (std::ostream& output, const FieldLine& l)
{
    ...
    output << "\tpixelloc: [" << l.m_location.screenCartesian.x << ", " << l.m_location.screenCartesian.y << "]" << std::endl;
    output << " angularloc: [" << l.m_location.screenAngular.x << ", " << l.m_location.screenAngular.y << "]" << std::endl;
    output << "\trelative field coords: [" << l.m_location.neckRelativeRadial.x << ", " << l.m_location.neckRelativeRadial.y << ", " << l.m_location.neckRelativeRadial.z << "]" << std::endl;
