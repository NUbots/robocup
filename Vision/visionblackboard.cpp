...
void VisionBlackboard::update()
{
    ...
    bool camera_pitch_valid, camera_yaw_valid, camera_height_valid, body_pitch_valid, body_roll_valid;
    float camera_pitch, camera_yaw, camera_height, body_pitch, body_roll;
    ...
    body_roll_valid = wrapper->getBodyRoll(body_roll);

    //set up neck position
    ...
    m_transformer.setSensors(camera_pitch, camera_yaw, body_roll, body_pitch, Vector3<double>(0.0, 0.0, 39.22));
