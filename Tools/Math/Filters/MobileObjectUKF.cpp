...
{
    m_velocity_decay = 0.99;    // Randomly guessed decay -- may not represent the real world.
}
...
Matrix MobileObjectUKF::processEquation(const Matrix& sigma_point, double deltaT, const Matrix& measurement)
{
    ...
    // In this case the measurment data is the odometry of the robot. This Should follow the format delta X, delta Y, delta Theta.
