...
class SharedMobileObjectModel : public IKFModel
{
public:
    ...
    SharedMobileObjectModel();

    IKFModel* Clone()
    {
        return new SharedMobileObjectModel(*this);
    }
...
protected:
    SharedMobileObjectModel(const SharedMobileObjectModel& source);
};
